...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2025 at 07:53 PM
...
CREATE TABLE `profiles` (
  ...
  `availability_status` enum('open','busy','not looking') DEFAULT NULL,
  `profile_theme` varchar(20) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `bio_snippet` varchar(150) DEFAULT NULL,
...
INSERT INTO `users` (`user_id`, `username`, `name`, `email`, `password`, `bio_snippet`, `user_type`, `created_at`, `last_login`) VALUES
(2, 'Mubarak Ahmed Saleh ElMughrabi', 'Mubarak Ahmed Saleh ElMughrabi', 'Admin0@mmu.edu.my', 'Admin0', NULL, 'admin', '2025-06-18 16:23:08', '2025-06-22 01:07:41'),
(3, 'Mohammed Aman', 'Mohammed Aman', 'Admin1@mmu.edu.my', 'Admin1', NULL, 'admin', '2025-06-18 19:30:26', '2025-06-21 12:19:36');
